...
const base = {servicesLoading: false, servicesError: '', services, categories: [{id: 'wash', name: 'Wash & Iron', count: 1}, {id: 'dry', name: 'Dry Cleaning', count: 1}], addresses: [{id: 'address', label: 'Home', address_line1: 'Banjara Hills', address_line2: null, city: 'Hyderabad', state: 'Telangana', postal_code: '500034', latitude: null, longitude: null, is_default: true}], selectedAddressId: 'address', cartItemCount: 0, getQuantity: () => 0, onSelectAddress: jest.fn(), onManageAddresses: jest.fn(), onOpenCart: jest.fn(), onOpenNotifications: jest.fn(), onRetryServices: jest.fn(), onUpdateQuantity: jest.fn()};
